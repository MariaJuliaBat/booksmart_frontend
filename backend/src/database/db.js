export const books = [
    { id: 1, nome: 'Cálculo, Volume 1', autor: 'Jamtes Stewar' },
    { id: 2, nome: 'Álgebra Linear com Aplicações', autor: 'Otto Bretscher' },
    { id: 3, nome: 'Matemática Discreta e Suas Aplicações', autor: 'Kenneth H. Rosen' },
    { id: 4, nome: 'Análise Real e Complexa', autor: 'Walter Rudin' },
    { id: 5, nome: 'Topologia Geral', autor: 'Stephen Willard' },
    { id: 6, nome: 'Cálculo Vetorial e Geometria Analítica', autor: 'George B. Thomas' },
    { id: 7, nome: 'Equações Diferenciais e Problemas de Valores de Contorno', autor: 'Dennis G. Zill' },
